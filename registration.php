...
<head>
        <title>Nina's Cake House || Sign Up</title>
...
<form class="row contact_us_form" action="" name="signup" method="post" onsubmit="return checkpass();">
    ...
    <div class="form-group col-md-6">
    <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" required="true" maxlength="12" pattern="[0-9]{12}" placeholder="Mobile Number" value="60" required="true">
    </div>
    <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-12">
        <button type="submit" value="submit" name="submit" class="btn order_s_btn form-control">Sign Up</button>
    </div>
    <div class="form-group col-md-12">
        <a href="login.php" class="btn order_s_btn form-control"><i class="ft-user"></i>Login if already have an account</a>
    </div>
</form>
