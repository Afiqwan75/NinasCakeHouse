...
<head>
    <title>Nina's Cake House || Dashboard</title>
...
?>
<a class="text-muted text-uppercase m-b-20" href="Cake-delivered.php" style="font-size: 20px"><strong>Total Cake Delivered</strong></a>
...
?>
<a class="text-muted text-uppercase m-b-20" href="user-detail.php" style="font-size: 20px"><strong>Total Registered User</strong></a>
