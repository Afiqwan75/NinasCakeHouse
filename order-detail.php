...
<head>
        ...
        <title>Nina's Cake House || Order Detail</title>
...
<th>RM<?php echo $grandtotal;?></th>
    ...
    <p style="color:red">
        <a href="javascript:void(0);" onClick="popUpWindow('cancelorder.php?oid=<?php echo $oid;?>');" title="Cancel this order" style="color:Black" class="btn pest_btn">Cancel Order </a>
    </p>
				</div>
