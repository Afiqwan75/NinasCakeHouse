...
<head>
        <title>Nina's Cake House || Sign In</title>
...
<form class="row contact_us_form" action="" name="login" method="post">
    ...
    <div class="form-group col-md-12">
        <a href="registration.php" class="btn order_s_btn form-control"><i class="ft-user"></i>Register if do not have an account</a>
    </div>
</form>
