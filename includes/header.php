...
?>
                        <a href="tell:+18004567890"><i class="fa fa-phone" aria-hidden="true"></i> +60 <?php  echo $row['MobileNumber'];?></a>
            ...
            <div class="main_menu_area">
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <img src="img/ninas.png" alt="" style="width: 121px; height: 73px;">
                        <img src="img/ninas2.png" alt="" style="width: 208px; height: 39px;">
                        </a>
