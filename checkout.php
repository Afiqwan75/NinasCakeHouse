...
//getting address
$fnaobno=$_POST['addressline1'];
$street=$_POST['addressline2'];
$area=$_POST['city'];
$lndmark=$_POST['postalcode'];
$city=$_POST['state'];
$cod=$_POST['cod'];
...
$query.="insert into tblorderaddresses(UserId,Ordernumber,addressline1,addressline2,city,postalcode,state) values('$userid','$orderno','$fnaobno','$street','$area','$lndmark','$city');";
...
<head>
        <title>Nina's Cake House || Checkout Page</title>
                		...
                		<div class="billing_form_area">
                			<form class="billing_form row" action="" method="post" id="contactForm">
								<div class="form-group col-md-6">
								    <label for="first">Address Line 1 *</label>
									<input type="text" name="addressline1"  placeholder="Address Line 1" class="form-control" required="true">
								</div>
								<div class="form-group col-md-6">
								    <label for="last">Address Line 2 *</label>
									<input type="text" name="addressline2" placeholder="Address Line 2" class="form-control" required="true">
								</div>
								...
								<div class="form-group col-md-12">
									...
									<input type="text" name="state" placeholder="State" class="form-control" equired="true">
								</div>
