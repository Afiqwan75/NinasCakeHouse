...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update tbluser set FirstName='$fname', LastName='$lname', MobileNumber='$contno', Email='$email' where ID='$sid'");
...
<head>
        <title>Nina's Cake House || Profile</title>
...
<div class="form-group col-md-12">
  ...
  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" value="<?php echo $row['MobileNumber']; ?>" required="true">
</div>
<div class="form-group col-md-12">
  <label style="color: black;">Registration Date</label>
  <input type="text" class="form-control" id="regdate" name="regdate" value="<?php echo $row['RegDate']; ?>" readonly="true">
</div>
<?php } ?>
<div class="form-group col-md-12">
  <button type="submit" value="submit" name="submit" class="btn order_s_btn form-control">Update Your Profile</button>
</div>
</form>
       				</div>
...
?>
       						...
       						<div class="contact_d_item">
       							<h5>Phone : +60<?php  echo $row['MobileNumber'];?></h5>
